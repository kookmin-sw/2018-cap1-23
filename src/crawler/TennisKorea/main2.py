    ...
    while True:
        ...
        try :
            for page in crawler._get_list():
                ...
                line_file.write(crawler._get_head(page))
                line_file.write("\n")
            #line_file.write(crawler._get_body(page))
...
#             remove_tag_file.write(crawler._remove_tag(page)+"\n")
#             line_file.write(crawler._c_get_head(page))
#             line_file.write("\n")
#             for x in crawler._get_body(page):
#                 line_file.write(x+"\n")
...
if __name__ == '__main__':
    ...
    url = 'http://tennis.co.kr/News/List?category=internal&page=1'
    ...
    #     os.mkdir(directory + '/original/')
    #     os.mkdir(directory + '/remove_tag/')
    # url = 'http://tennis.co.kr/Cafe/PromotionList?category=promotion&page=1'
    # base_url = 'http://tennis.co.kr'
    # crawler = TennisCrawler(url = url, base_url = base_url)
