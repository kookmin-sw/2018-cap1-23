...
doc_vectorizer = doc2vec.Doc2Vec(min_count=word_min_count, vector_size=vector_size, alpha=0.025, min_alpha=0.025, seed=1234, workers=worker_count)
...
for epoch in range(5):
	...
	doc_vectorizer.train(sentences, total_examples= corpus_count, epochs= 1)
